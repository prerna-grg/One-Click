		...
		<div class="gtco-container text-center">
			<div class="display-t">
				<div class="display-tc">
					<h1 class="animate-box"><?php echo $courseName;?></h1>
						<form action="upload.php?courseName=<?php echo $courseName; ?>" method="POST" enctype="multipart/form-data">
         				<h2>Upload the csv file:</h2>
         				<input style="position:relative;width:800px;" type="file" name="image" />
         				<input class="w3-button w3-green" type="submit" name="submit" value="Submit"/>

         				<input type="button" class="w3-button w3-green" onclick="window.location.href='<?php echo "../course/$vcsv" ?>'"/ value="Download CSV">
      					</form>
