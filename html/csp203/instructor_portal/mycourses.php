...
<html>
				...
				<div class="row">
					<div class="col-xs-12 text-center menu-1">
						<ul>
							...
							<li class="active"><a href="mycourses.php">My Courses</a></li>
	...
	<?php
		...
		if($result = $connection->query("SELECT CourseName,CourseTitle FROM course JOIN Instructor_courses on course.CourseID=Instructor_courses.CourseID JOIN instructor on Instructor_courses.InstructorID=instructor.InstructorID WHERE instructor.email='$userEmail'")){
			if($count = $result->num_rows){
				while($row=mysqli_fetch_row($result)){
				$CourseName=$row[0];
				$CourseTitle=$row[1];
				echo 	"<div class=\"col-lg-4 col-md-4 col-sm-6\">
							<a href=\"course_details.php?courseName=$CourseName\" class=\"gtco-card-item\">
								<figure>
									<div class=\"overlay\"><i class=\"ti-plus\"></i></div>
									<img src=\"images/img_1.jpg\".png\" alt=\"Image\" class=\"img-responsive\">
								</figure>
								<div class=\"gtco-text\">
									<h2>$CourseName</h2>
									<p>$CourseTitle</p>
