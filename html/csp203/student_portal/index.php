...
<html>
		...
		<div class="gtco-container">
			<div class="row row-mt-15em">
				<div class="col-md-12 mt-text text-center animate-box" data-animate-effect="fadeInUp">
					...
					<div class="text-center"><a href="join_course.php?x=join" class="btn btn-primary btn-lg">Join a new course</a></div>
				</div>
			</div>
		</div>
	</header>
	...
	<div class="gtco-cover gtco-cover-sm" style="background-image: url(images/img_bg_1.jpg)"  data-stellar-background-ratio="0.5"><div class="overlay"></div>
