			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-xs-12 text-center menu-1">
						<ul>
							<li class="active"><a href="index.html">What is OneClick</a></li>
						</ul>
					</div>
				</div>
		...
		<div class="gtco-container">
			<div class="row row-mt-15em">
				<div class="col-md-12 mt-text text-center animate-box" data-animate-effect="fadeInUp">
					...
					<div class="text-center"><a href="instructor_portal/login_page.php" class="btn btn-primary btn-lg">Instructor</a></div>
					<div class="text-center"><a href="student_portal/login_page.php" class="btn btn-primary btn-lg">Student</a></div>
				</div>
			</div>
		</div>
	</header>
